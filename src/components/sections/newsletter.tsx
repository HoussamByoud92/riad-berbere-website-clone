          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center">
            <div className="lg:w-3/5">
              <h6 className="font-secondary text-xs font-bold uppercase tracking-[2px]">
                RESTEZ INFORMÉS AVEC DIFFA TOURS
              </h6>
              <h3 className="mt-4 max-w-[500px] font-display text-[28px] font-normal leading-tight lg:text-[32px]">
                Inscrivez-vous à notre newsletter pour recevoir nos meilleures offres de voyages, nouveaux circuits et promotions exclusives.
              </h3>
            </div>
