      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-8 py-[100px] text-center text-white">
        ...
        <blockquote className="relative my-6 max-w-[700px]">
          ...
          <p className="font-display leading-[1.6] [font-size:clamp(1.5rem,2.5vw,1.75rem)]">
            Une expérience exceptionnelle avec Diffa Tours ! L'organisation était parfaite, les guides passionnés et les découvertes inoubliables. Le Maroc nous a révélé toute sa beauté grâce à cette équipe professionnelle. Je recommande vivement !
          </p>
