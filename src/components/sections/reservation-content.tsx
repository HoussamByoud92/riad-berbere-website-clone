    ...
    <div className="max-w-[1400px] mx-auto px-4 py-12">
      <div className="grid grid-cols-1 lg:grid-cols-[330px_1fr] gap-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 h-fit sticky top-24">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-semibold text-base">Price (DHS)</h3>
              <button className="text-primary text-sm hover:text-primary/80">Ok</button>
            </div>
        ...
        <div>
          <div className="mb-8">
            <h1 className="text-3xl font-display font-light mb-2">Nos Circuits Disponibles</h1>
            <p className="text-muted">Découvrez nos circuits exceptionnels à travers le Maroc</p>
          </div>
          ...
          {filteredTours.length === 0 && (
            <div className="text-center py-12">
              <p className="text-muted text-lg">Aucun circuit disponible dans cette gamme de prix.</p>
            </div>
          )}
        </div>
      </div>
